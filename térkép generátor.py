...
import pandas as pd
import math as math
térkép = pd.read_excel(r"D:\Szabi\Medve\Egész hetes kaland\kiértékelő program\térkép állás.xlsx", sheet_name="térkép") #r után a térképes excel elérése
színek = pd.read_excel(r"D:\Szabi\Medve\Egész hetes kaland\kiértékelő program\térkép állás.xlsx", sheet_name="játékos színek") #r után a térképes excel elérése
